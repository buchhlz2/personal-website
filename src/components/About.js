					...
					<div className='col-md-10 mx-auto'>
						<div className='card' id='about-me-card'>
							...
							<div className='card-body font-trebuchet text-justify ml-3 mr-3' id='about-me-content'>
								...
								<p>
									<b>DESCRIPTION</b>="Passion for startups and all things tech &#8212; Chicago native, currently based
									in San Francisco. Engineering alumn of the{' '}
									<a
								...
								<p>
									...
									science, fitness, and music. Essentially, a slight obsession with "the science of" why things exist as
									they do."
								</p>
								<p>
									<b>DESIRE</b>="Looking to{' '}
